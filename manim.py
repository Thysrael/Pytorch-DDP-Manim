...
class VisualiseNeuralNetwork(Scene):
    def construct(self):
        ...
        # Play Create animations and then wait seconds
        ...
        while epoch < 20:
            ...
            for index in range(0, train.shape[0]):
                ...
                if animate:
                    ...
                    self.animate_connections(h1_nodes_list, h2_nodes_list, connections_1, w2)
    ...
    def create_prediction_text(self, prediction, left_shift):
        ...
        # Create Header Text
        prediction_header = Text("Prediction", font_size=self.HEADER_FONT_SIZE)
    ...
    def animate_connections(self, left_layer_centers, right_layer_centers
        ...
        self.play(Transform(line_group, new_line_group), run_time=self.ANIMATION_RUN_TIME)
